...
public class GameInfo extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Logic gameLogic = (Logic) getArguments().getSerializable(GameActivity.GAME_KEY);

        TextView currentPlayer = gameInfoView.findViewById(R.id.current_player);
        currentPlayer.setText(String.format(getString(R.string.current_player), gameLogic.getCurrentPlayer().toString()));

        TextView currentTurn = gameInfoView.findViewById(R.id.current_turn);
